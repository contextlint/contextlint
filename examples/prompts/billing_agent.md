...
## Billing specifics
In order to explain an invoice, walk the customer through line items one at a time.
Due to the fact that tariffs change quarterly, always state the effective date.
